...
│   │   └── commands.py          # Комманды для работы с ботом
│   ├── config/
...
### 5. Запуск workfow n8n

```
После запуска контейнера зайдите в localhost:5678. Создайте workfrow. Внутри него нажмите import from File, выбирите workflow_bot_listener.json
```
